...
header("Content-Disposition: attachment; filename="."list_transaksi_". "$date".".xls");
	...
	<tbody>
		...
		<?php foreach ($transaksi as $b) { ?>
			<tr>
				...
				<td align="left"><?php echo $b['id_transaksi']; ?></td>
				<td align="left"><?php echo $b['nama_user']; ?></td>
				<td align="left"><?php echo $b['nama']; ?></td>
				<td align="left"><?php echo $b['tgl_wkt']; ?></td>
				<td align="left"><?php echo $b['bayar']; ?></td>
				<td align="left"><?php echo $b['total']; ?></td>
				<td align="left"><?php echo $b['kembali']; ?></td>
			</tr>
			<?php $i++; ?>

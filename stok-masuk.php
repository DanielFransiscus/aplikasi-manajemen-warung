...
<body class="sb-nav-fixed">
                ...
                <tbody>
                  ...
                  <?php foreach ($barang as $b) { ?>
                    <tr>
                      ...
                      <td>
                        <?php echo htmlentities($b['tgl_msk']); ?>
                      </td>
                      <td>
                        ...
                        <div class="modal-content">
                          ...
                          <form action="<?php echo BASEURL; ?>/stok-masuk" method="post">
                            <div class="modal-body">
                              ...
                              <input type="hidden" name="id_masuk" value="<?php echo $b['id_masuk']; ?>">
                            </div>
                            <div class="modal-footer">
  ...
  <script script src="<?php echo BASEURL; ?>/assets/js/fontawesome.js"></script>

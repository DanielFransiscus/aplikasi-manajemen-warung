            ...
            <div class="card-body">
              ...
              <table id="datatablesSimple">
                <div class="clearfix">
                  ...
                  <a class="btn btn-primary mb-4 float-end" href="<?php echo BASEURL; ?>/satuan-barang/tambah" role="button">Tambah</a>
                  ...
                  <?php foreach ($satuans as $c) { ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="btn btn-success" href="<?php echo BASEURL; ?>/satuan-barang/ubah?id=<?php echo $c['id_satuan'] ?>">Ubah</a>
                        <a class="btn btn-danger" href="<?php echo BASEURL; ?>/satuan-barang/hapus?id=<?php echo $c['id_satuan'] ?>" onclick="return confirm('Apakah anda yakin menghapus data ini ?')">Hapus</a>
                    ...
                    <div class="modal fade" id="edit<?php echo $c['id_satuan']; ?>">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <form action="<?php echo BASEURL; ?>/satuan-barang" method="post">
                            <!-- Modal body -->
